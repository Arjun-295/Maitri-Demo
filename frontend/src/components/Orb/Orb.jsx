...
// Custom hook for microphone input removed as it is handled by parent
...
function PulsatingSphere({ voiceFrequency }) {
  ...
  useFrame((state) => {
    ...
    material.emissiveIntensity = THREE.MathUtils.lerp(
      ...
      0.5 + voiceFrequency / 40,
      0.1,
    );
  });

  return <Sphere ref={meshRef} args={[1.5, 32, 32]} material={material} />;
}

export default function Orb({ voiceFrequency = 0 }) {
  // voiceFrequency is now passed as a prop from layout
